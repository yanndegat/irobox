...
OPENSTACK_HOST = os.environ['OPENSTACK_HOST']
OPENSTACK_KEYSTONE_URL = os.environ['OPENSTACK_KEYSTONE_URL']
...
OPENSTACK_KEYSTONE_DEFAULT_DOMAIN = os.environ['OS_PROJECT_DOMAIN_NAME']
