...
const panicOutput = `
!!!!!!!!!!!!!!!!!!!!!!!!!!! IROBOX CRASH !!!!!!!!!!!!!!!!!!!!!!!!!!!!
Irobox crashed! This is always indicative of a bug within irobox.
Please report the crash with Irobox[1] so that we can fix this.
When reporting bugs, please include your irobox version, the stack trace
shown below, and any additional information which may help replicate the issue.
[1]: -live-prod-030-nodes-vm/pull-requests/13/overview
!!!!!!!!!!!!!!!!!!!!!!!!!!! IROBOX CRASH !!!!!!!!!!!!!!!!!!!!!!!!!!!!
`

// PanicHandler is called to recover from an internal panic in irobox, and
